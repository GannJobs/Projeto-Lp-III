...
public class Dados extends javax.swing.JFrame {
    ...
    public Dados(Diretor diretor) {
        ...
        jLabel13.setText( diretor.getTelefone());
        jLabel11.setText( diretor.getEmail());
        jLabel14.setText( diretor.getCPF());
        jLabel15.setText( diretor.getData());
        jLabel17.setText( diretor.getAdmExtenso());
        jLabel16.setText( diretor.getCargo());
        jLabel20.setText(Double.toString( diretor.getSalarioBaseDiretor()));
    }
