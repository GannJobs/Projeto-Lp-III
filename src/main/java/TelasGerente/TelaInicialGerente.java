...
public class TelaInicialGerente extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Bem Vindo Gerente User");
        ...
        jButton2.setText("Promover Funcionário");

        jButton3.setText("Outra função");

        jLabel2.setText("Departmento de X");

        jButton4.setText("Contratar Funcionário");

        jButton5.setText("Demitir Funcionário");
        ...
        jButton6.setText("Editar Funcionário");

        jButton7.setText("Dar Aumento");
