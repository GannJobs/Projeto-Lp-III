...
public class Dados extends javax.swing.JFrame {
    ...
    public Dados(Estagiario estagiario) {
        initComponents();
        jLabel12.setText(estagiario.getNome());
        jLabel11.setText(estagiario.getTelefone());
        jLabel13.setText(estagiario.getEmail());
        jLabel14.setText(estagiario.getCPF());
        jLabel17.setText(estagiario.getDataNascimentoExtenso());
        jLabel15.setText(estagiario.getAdmExtenso());
        jLabel16.setText(estagiario.getCargo());
        jLabel18.setText(estagiario.getDuracaoEstagioStr());
        List<Departamento> lista = new ArrayList<>();
        Gerente gerente = new Gerente("joabe", "123",20,"123123", "aa@aa.com", "4564654", Data.getDataAtual(), Data.getDataAtual(), "Gerente", 1);
        lista.add(new Departamento("vendas",gerente.getDepartamento()));
        Departamento dep = new Departamento(Departamento.buscarDepartamentoPorCodigo(lista, estagiario.getDepartamento()));
        jLabel19.setText(dep.getNome());
        jLabel20.setText(Double.toString(estagiario.getSalario()));
        jLabel21.setText(estagiario.getFuncao());
    }
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Duração do Estágio:");
