...
public class Dados extends javax.swing.JFrame {
    ...
    public Dados(Empregado empregado) {
        initComponents();
        jLabel12.setText(empregado.getNome());
        jLabel13.setText(empregado.getTelefone());
        jLabel11.setText(empregado.getEmail());
        jLabel14.setText(empregado.getCPF());
        jLabel15.setText(empregado.getData());
        jLabel17.setText(empregado.getAdmExtenso());
        jLabel16.setText(empregado.getCargo());
        ...
        Departamento dep = new Departamento(Departamento.buscarDepartamentoPorCodigo(lista, empregado.getDepartamento()));
        jLabel19.setText(dep.getNome());
        jLabel20.setText(Double.toString(empregado.getSalario()));
        jLabel22.setText(empregado.getFuncao());
    }
